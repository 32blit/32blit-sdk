...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspInit 0 */
    ...
    PC12     ------> UART5_TX 
    */
    GPIO_InitStruct.Pin = LED_CHG_RED_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART5;
    HAL_GPIO_Init(LED_CHG_RED_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END UART8_MspInit 0 */
    ...
    PE1     ------> UART8_TX 
    */
    GPIO_InitStruct.Pin = LED_CHG_GREEN_Pin|LED_CHG_BLUE_Pin;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PC12     ------> UART5_TX 
    */
    HAL_GPIO_DeInit(LED_CHG_RED_GPIO_Port, LED_CHG_RED_Pin);
  ...
  /* USER CODE END UART8_MspDeInit 0 */
    ...
    PE1     ------> UART8_TX 
    */
    HAL_GPIO_DeInit(GPIOE, LED_CHG_GREEN_Pin|LED_CHG_BLUE_Pin);
