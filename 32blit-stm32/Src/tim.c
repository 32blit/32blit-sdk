...
void MX_TIM4_Init(void)
{
  ...
  htim4.Instance = TIM4;
  htim4.Init.Prescaler = 117; // TODO: Exported from STM Cube as 1080-1
  htim4.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim4.Init.Period = 10000; // TODO: Exported from STM Cube as 2000-1
...
void MX_TIM15_Init(void)
{
  ...
  htim15.Init.Prescaler = 100; // TODO: Exported from STM Cube as 0
  htim15.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim15.Init.Period = 10000; // TODO: Exported from STM Cube as 0
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE BEGIN TIM15_MspPostInit 1 */
    ...
    __HAL_TIM_SetCompare(&htim15, TIM_CHANNEL_1, 10000);
