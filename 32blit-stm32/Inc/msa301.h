...
/*
class MSA301 {
  MSA301(I2C_HandleTypeDef *i2c, uint8_t power_mode, uint8_t output_data_rate);
  MSA301(I2C_HandleTypeDef *i2c);

  void transmit(uint8_t reg, uint8_t data);

  static const uint8_t address = 0x26; // 7-bit I2C address (fixed)
