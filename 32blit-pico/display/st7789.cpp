...
static void command(uint8_t command, size_t len = 0, const char *data = NULL);
...
static void init(bool auto_init_sequence = true) {
  // configure pins
...
static void update(bool dont_block = false) {
